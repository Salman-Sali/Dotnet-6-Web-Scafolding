...
namespace WebApp.Extentions
{
    public static class ControllerExtensions
    {
        public static IActionResult OkResult(this ControllerBase controller, object data)
        {
            ...
            return controller.Ok(AppApiResponse<object>.Success(data));
        }

        public static IActionResult OkResult(this ControllerBase controller, string message)
        {
            if (string.IsNullOrWhiteSpace(message))
                throw new ArgumentNullException($"{nameof(message)} cannot be null or empty.");

            return controller.Ok(AppApiResponse<object>.Success(message));
        }
        ...
        public static IActionResult OkResult(this ControllerBase controller, object data, string message)
        {
            ...
            return controller.Ok(AppApiResponse<object>.Success(data, message));
        }
        ...
        public static IActionResult BadRequestResult(this ControllerBase controller, string errorMessage)
        {
            ...
            return controller.BadRequest(AppApiResponse<object>.Failed(errorMessage, HttpStatusCode.BadRequest));
        }
        ...
        public static IActionResult NotFoundResult(this ControllerBase controller, string errorMessage)
        {
            ...
            return controller.NotFound(AppApiResponse<object>.Failed(errorMessage, HttpStatusCode.NotFound));
        }
        ...
        public static IActionResult InternalServerErrorResult(this ControllerBase controller, string errorMessage)
        {
            ...
            return controller.StatusCode(Convert.ToInt32(HttpStatusCode.InternalServerError),
                AppApiResponse<object>.Failed(errorMessage, HttpStatusCode.InternalServerError));
        }
    }
}
